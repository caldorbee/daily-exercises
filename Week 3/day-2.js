...
document.querySelector("#question2").innerHTML = "2. <button>1</button><button>2</button><button>3</button><button>4</button><button>5</button>"

document.querySelector("#question3").innerHTML = "3. <h2></h2><h2></h2><h2></h2><h2></h2><h2></h2>"

document.querySelector("#question4").innerHTML = (htmlPics)
